        ...
        <main>
            <section class="milano">
                ...
                <?php if (!empty($city['hero'])) { ?>
                    <div class="milano__banner" style="background-image: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('<?= BASE_URL ?>public/assets/img/<?= $city['hero']['image'] ?>');">
                ...
                <?php if (!empty($city['social_media'])) { ?>
                    <div class="milano__social-bar">
                        ...
                        <?php if (!empty($city['social_media']['instagram'])) { ?>
                            <a href="<?= $city['social_media']['instagram'] ?>" target="_blank" class="milano__social-link" title="Instagram">
                        ...
                        <?php if (!empty($city['social_media']['whatsapp'])) { ?>
                            <a href="<?= $city['social_media']['whatsapp'] ?>" target="_blank" class="milano__social-link" title="WhatsApp">
                        ...
                        <?php if (!empty($city['social_media']['maps'])) { ?>
                            <a href="<?= $city['social_media']['maps'] ?>" target="_blank" class="milano__social-link" title="Visualizza su Google Maps">
                    ...
                    <div class="milano__info">
                        <?php foreach ($city['info_box'] as $info) { ?>
                            <p class="milano__info-row">
                                <span class="milano__info-label"><?= $info['label'] ?></span>
                                <span class="milano__info-value"><?= $info['content'] ?></span>
                            </p>
                        <?php } ?>
                    </div>
                <?php } ?>
                    ...
                    <div class="milano__pastor">
                        <div class="milano__pastor-container">
                            <div class="milano__pastor-img-box">
                                <img src="<?= BASE_URL ?>public/assets/img/<?php echo $city['board']['pastor_image'] ?>" alt="Famiglia Pastorale" class="milano__pastor-img">
                            </div>
                    ...
                    <div class="milano__city">
                        <div class="milano__city-container">
                            <div class="milano__city-img-box">
                                <img src="<?= BASE_URL ?>public/assets/img/<?php echo $city['city_description']['map_image'] ?>" alt="Mappa" class="milano__city-img">
                            </div>
