    ...
    <div class="container-fluid px-4" style="max-width: 1440px;">
        ...
        <div class="collapse navbar-collapse" id="navCPUE">
            <ul class="navbar-nav fw-semibold mx-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu shadow">
                        ...
                        <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>about#consiglio-direttivo">Consiglio Direttivo Nacional</a></li>
                    </ul>
                </li>
            ...
            <div class="d-flex justify-content-end navbar-login-container pt-3 pt-lg-0">
                <a href="<?php echo BASE_URL; ?>login" class="text-white-50 d-inline-block opacity-75" title="Admin Access">
